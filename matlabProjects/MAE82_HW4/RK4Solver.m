function [tout, yout] = RK4Solver(ODEfunIn, solveTime, y0, stepSize) % This in an implementation of euler's method. Inputs are as follows: % - ODEfunIn is a function handle to a differential equation
