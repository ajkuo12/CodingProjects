...
impSolFun = @(a,t) [];  % **put F_imp in place of the brackets, and delete 
...
t_range = []; % should have the format [start_time, end_time]
...
averageStepODE = []; % ** Replace the brackets with code to calculate the
...
% ODE45
[t_bigStep, a_bigStep] = []; % ** Fill in the brackets with code to solve
